...
export class VehiculosComponent implements OnInit {
  ...
  onVehiculoEliminar(vehiculo: Vehiculo){
     this.datosTecnicosInteresService.deleteDatosTecnicosInteres(this.datosTecnicosInteres.id).subscribe(data =>{
      this.mantenimientoPreventivoService.deleteMantenimientoPreventivo(this.mantenimientoPreventivo.id).subscribe(data2 =>{
